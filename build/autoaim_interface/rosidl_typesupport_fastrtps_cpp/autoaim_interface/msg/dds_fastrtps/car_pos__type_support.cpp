...
#include "autoaim_interface/msg/car_pos__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoaim_interface::msg::CarPos & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoaim_interface::msg::CarPos & ros_message)
{
  // Member: armor_name
  cdr >> ros_message.armor_name;
...
{
  auto typed_message =
    static_cast<const autoaim_interface::msg::CarPos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoaim_interface::msg::CarPos *>(
    untyped_ros_message);
...
{
  return max_serialized_size_CarPos(full_bounded, 0);
}
...
{
  return &autoaim_interface::msg::typesupport_fastrtps_cpp::_CarPos__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoaim_interface, msg, CarPos)() {
  return &autoaim_interface::msg::typesupport_fastrtps_cpp::_CarPos__handle;
}
