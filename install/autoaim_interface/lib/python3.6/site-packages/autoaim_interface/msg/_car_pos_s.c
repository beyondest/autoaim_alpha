...
bool autoaim_interface__msg__car_pos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "autoaim_interface.msg._car_pos.CarPos",
        full_classname_dest, 37) == 0);
  }
  autoaim_interface__msg__CarPos * ros_message = _ros_message;
  {  // armor_name
...
PyObject * autoaim_interface__msg__car_pos__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoaim_interface.msg._car_pos");
